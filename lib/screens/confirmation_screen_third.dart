...
class ConfirmationScreenThird extends StatelessWidget {
  const ConfirmationScreenThird({super.key});
  ...
  // Dropdown Row for Social Link
  Widget _buildDropdownRow(String title) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0),
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            DropdownButton<String>(
              underline: SizedBox(), // Removes the dropdown underline
